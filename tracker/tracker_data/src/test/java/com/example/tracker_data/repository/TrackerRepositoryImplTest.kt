...
import com.example.tracker_data.response.malformedFoodResponse
import com.example.tracker_data.response.validFoodResponse
...
class TrackerRepositoryImplTest {
    ...
    fun setup() {
        ...
        val mockDao = mockk<TrackerDao>(relaxed = true)
